      ...
      <div className="flex flex-col items-center gap-8">
        <div className="text-center">
          <h1 className="text-2xl font-bold">
            Make dreams come true and earn!
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-16 relative w-full max-w-6xl">
          {/* Card 1 */}
          <div className="relative flex flex-col items-center">
            ...
            {/* Line to next card */}
            <div className="hidden sm:block absolute top-1/4 right-0 transform translate-x-1/2">
              <svg
                width="210"
                height="15"
                viewBox="0 0 210 15"
